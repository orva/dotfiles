...
local function config()
  ...
  ls.setup({sources = {ls.builtins.diagnostics.eslint, ls.builtins.diagnostics.clj_kondo, ls.builtins.formatting.biome, ls.builtins.formatting.zprint, ls.builtins.formatting.rustfmt}})
