...
local function config()
  ...
  return ls.setup({sources = {ls.builtins.diagnostics.eslint, ls.builtins.diagnostics.clj_kondo, ls.builtins.formatting.prettier, ls.builtins.formatting.zprint, ls.builtins.formatting.rustfmt}})
end
