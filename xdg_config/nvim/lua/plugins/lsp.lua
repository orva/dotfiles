...
local function config()
  ...
  mason.setup()
  mason_lspconfig.setup({ensure_installed = {"clangd", "pyright", "rust_analyzer", "clojure_lsp", "tsserver", "marksman"}})
  lspconfig.clangd.setup({capabilities = capabilities})
  lspconfig.pyright.setup({capabilities = capabilities})
  lspconfig.rust_analyzer.setup({capabilities = capabilities})
  lspconfig.clojure_lsp.setup({capabilities = capabilities})
  lspconfig.tsserver.setup({capabilities = capabilities})
  lspconfig.fennel_ls.setup({capabilities = capabilities, root_dir = vcs_root_dir(), settings = {["fennel-ls"] = {["extra-globals"] = "vim love"}}, single_file_support = false})
