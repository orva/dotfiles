...
return dep_spec("neovim/nvim-lspconfig", {dependencies = {"telescope", "hrsh7th/nvim-cmp", "hrsh7th/cmp-nvim-lsp", "saadparwaiz1/cmp_luasnip", "L3MON4D3/LuaSnip"}, config = config})
